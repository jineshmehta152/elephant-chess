...
export default function ColorfulFAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Elephant Chess Academy curriculum is mapped with official FIDE international chess coaching standards, Grandmaster tactical modules, and candidate move calculation methodologies.",
      theme: "red",
    },
  ]
            ...
            <div className="relative group">
              ...
              <div className="absolute -bottom-6 -left-2 sm:-left-6 md:-left-8 bg-white p-3 md:p-4 rounded-2xl shadow-2xl border border-slate-100 flex items-center gap-3 md:gap-4 animate-float z-20">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-lg font-black text-slate-800 tracking-tight">+91 98878 21721</p>
                </div>
              </div>
