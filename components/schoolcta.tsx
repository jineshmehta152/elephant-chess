...
export default function PrimaryCTA() {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16 md:mb-24 text-center">
          ...
          <p className="text-slate-500 font-bold text-base md:text-xl max-w-2xl mx-auto mb-10 md:mb-12">
            Step inside Elephant Chess Academy and witness the joy of interactive master learning. Witness the premium 
  ...
  <Link href="#bookdemo" data-book-demo="true" className="w-full lg:w-auto">
