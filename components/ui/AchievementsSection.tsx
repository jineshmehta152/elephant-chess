...
const AchievementsSection: React.FC = () => {
  ...
  return (
    <section className="relative py-12 md:py-14 lg:py-22 bg-white overflow-hidden font-sans">
      ...
      {/* Background Glows */}
      <div className="absolute top-0 right-0 w-64 h-64 md:w-[500px] md:h-[500px] bg-sky-100/40 rounded-full blur-[80px] md:blur-[100px] pointer-events-none -translate-y-1/2 translate-x-1/2"></div>
      <div className="absolute bottom-0 left-0 w-64 h-64 md:w-[500px] md:h-[500px] bg-amber-100/40 rounded-full blur-[80px] md:blur-[100px] pointer-events-none translate-y-1/2 -translate-x-1/2"></div>
